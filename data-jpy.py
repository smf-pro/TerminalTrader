# -*- coding: utf-8 -*-
"""
data-jpy.py - Script d'extraction de l'HISTORIQUE des indicateurs
economiques JPY - ForexFactory Calendar (version cloud, patron TerminalTrader)
----------------------------------------------------------------------
Reprend la logique de scraping du script local `ffus.py` (tableau
"History" de chaque page calendrier ForexFactory, ex :
https://www.forexfactory.com/calendar/641-jn-boj-policy-rate) mais l'adapte au
...
# Liens ForexFactory a suivre pour le JPY. Ajoute / supprime / commente
# une ligne pour modifier la liste des indicateurs suivis.
LIENS = [
    # Taux
    "https://www.forexfactory.com/calendar/641-jn-boj-policy-rate",
    # Inflation
    "https://www.forexfactory.com/calendar/631-jn-boj-core-cpi-yy",
    "https://www.forexfactory.com/calendar/175-jn-tokyo-core-cpi-yy",
    "https://www.forexfactory.com/calendar/181-jn-average-cash-earnings-yy",
    # Emploi
    "https://www.forexfactory.com/calendar/63-jn-unemployment-rate",
    # Croissance
    "https://www.forexfactory.com/calendar/36-jn-prelim-gdp-qq",
    "https://www.forexfactory.com/calendar/37-jn-final-gdp-qq",
    "https://www.forexfactory.com/calendar/359-jn-household-spending-yy",
    "https://www.forexfactory.com/calendar/43-jn-prelim-gdp-price-index-yy",
]
...
NOM_SOURCE = "data-jpy"  # identifiant unique de ce script dans pipeline_status
DOSSIER_CACHE = "cache"
