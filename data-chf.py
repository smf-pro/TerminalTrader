# -*- coding: utf-8 -*-
"""
data-chf.py - Script d'extraction de l'HISTORIQUE des indicateurs
economiques CHF - ForexFactory Calendar (version cloud, patron TerminalTrader)
----------------------------------------------------------------------
Reprend la logique de scraping du script local `ffus.py` (tableau
"History" de chaque page calendrier ForexFactory, ex :
https://www.forexfactory.com/calendar/834-sz-snb-policy-rate) mais l'adapte au
...
# Liens ForexFactory a suivre pour le CHF. Ajoute / supprime / commente
# une ligne pour modifier la liste des indicateurs suivis.
LIENS = [
    # Taux
    "https://www.forexfactory.com/calendar/834-sz-snb-policy-rate",
    # Inflation
    "https://www.forexfactory.com/calendar/100-sz-cpi-mm",
    # Emploi
    "https://www.forexfactory.com/calendar/62-sz-unemployment-rate",
    "https://www.forexfactory.com/calendar/273-sz-manufacturing-pmi",
    # Croissance
    "https://www.forexfactory.com/calendar/32-sz-gdp-qq",
    "https://www.forexfactory.com/calendar/109-sz-retail-sales-yy",
    "https://www.forexfactory.com/calendar/301-sz-kof-economic-barometer",
]
...
NOM_SOURCE = "data-chf"  # identifiant unique de ce script dans pipeline_status
DOSSIER_CACHE = "cache"
