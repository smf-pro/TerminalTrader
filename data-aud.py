# -*- coding: utf-8 -*-
"""
data-aud.py - Script d'extraction de l'HISTORIQUE des indicateurs
economiques AUD - ForexFactory Calendar (version cloud, patron TerminalTrader)
----------------------------------------------------------------------
Reprend la logique de scraping du script local `ffus.py` (tableau
"History" de chaque page calendrier ForexFactory, ex :
https://www.forexfactory.com/calendar/21-au-cash-rate) mais l'adapte au
...
# Liens ForexFactory a suivre pour l'AUD. Ajoute / supprime / commente
# une ligne pour modifier la liste des indicateurs suivis.
LIENS = [
    # Taux
    "https://www.forexfactory.com/calendar/21-au-cash-rate",
    # Inflation
    "https://www.forexfactory.com/calendar/888-au-cpi-yy",
    "https://www.forexfactory.com/calendar/99-au-trimmed-mean-cpi-mm",
    "https://www.forexfactory.com/calendar/98-au-cpi-mm",
    "https://www.forexfactory.com/calendar/245-au-commodity-prices-yy",
    "https://www.forexfactory.com/calendar/182-au-wage-price-index-qq",
    # Emploi
    "https://www.forexfactory.com/calendar/64-au-unemployment-rate",
    "https://www.forexfactory.com/calendar/73-au-employment-change",
    # Croissance
    "https://www.forexfactory.com/calendar/31-au-gdp-qq",
]
...
NOM_SOURCE = "data-aud"  # identifiant unique de ce script dans pipeline_status
DOSSIER_CACHE = "cache"
