# -*- coding: utf-8 -*-
"""
data-cad.py - Script d'extraction de l'HISTORIQUE des indicateurs
economiques CAD - ForexFactory Calendar (version cloud, patron TerminalTrader)
----------------------------------------------------------------------
Reprend la logique de scraping du script local `ffus.py` (tableau
"History" de chaque page calendrier ForexFactory, ex :
https://www.forexfactory.com/calendar/13-ca-overnight-rate) mais l'adapte au
...
# Liens ForexFactory a suivre pour le CAD. Ajoute / supprime / commente
# une ligne pour modifier la liste des indicateurs suivis.
# NOTE : "full-time-employment" (TradingEconomics) n'est PAS inclus ici -
# ce n'est pas du ForexFactory, ce script ne sait pas le scraper (structure
# de page totalement differente). A traiter separement si besoin.
LIENS = [
    # Taux
    "https://www.forexfactory.com/calendar/13-ca-overnight-rate",
    # Emploi
    "https://www.forexfactory.com/calendar/57-ca-unemployment-rate",
    "https://www.forexfactory.com/calendar/67-ca-employment-change",
    # Inflation
    "https://www.forexfactory.com/calendar/659-ca-median-cpi-yy",
    "https://www.forexfactory.com/calendar/657-ca-trimmed-cpi-yy",
    "https://www.forexfactory.com/calendar/664-ca-common-cpi-yy",
    "https://www.forexfactory.com/calendar/81-ca-core-cpi-mm",
    "https://www.forexfactory.com/calendar/90-ca-ippi-mm",
    # Croissance
    "https://www.forexfactory.com/calendar/29-ca-gdp-mm",
    "https://www.forexfactory.com/calendar/104-ca-retail-sales-mm",
    "https://www.forexfactory.com/calendar/103-ca-core-retail-sales-mm",
    "https://www.forexfactory.com/calendar/254-ca-ivey-pmi",
]
...
NOM_SOURCE = "data-cad"  # identifiant unique de ce script dans pipeline_status
DOSSIER_CACHE = "cache"
