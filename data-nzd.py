# -*- coding: utf-8 -*-
"""
data-nzd.py - Script d'extraction de l'HISTORIQUE des indicateurs
economiques NZD - ForexFactory Calendar (version cloud, patron TerminalTrader)
----------------------------------------------------------------------
Reprend la logique de scraping du script local `ffus.py` (tableau
"History" de chaque page calendrier ForexFactory, ex :
https://www.forexfactory.com/calendar/23-nz-official-cash-rate) mais l'adapte au
...
# Liens ForexFactory a suivre pour le NZD. Ajoute / supprime / commente
# une ligne pour modifier la liste des indicateurs suivis.
LIENS = [
    # Taux
    "https://www.forexfactory.com/calendar/23-nz-official-cash-rate",
    # Inflation
    "https://www.forexfactory.com/calendar/173-nz-cpi-qq",
    "https://www.forexfactory.com/calendar/190-nz-anz-commodity-prices-mm",
    "https://www.forexfactory.com/calendar/309-nz-inflation-expectations-qq",
    # Emploi
    "https://www.forexfactory.com/calendar/65-nz-unemployment-rate",
    "https://www.forexfactory.com/calendar/74-nz-employment-change-qq",
    # Croissance
    "https://www.forexfactory.com/calendar/30-nz-gdp-qq",
    "https://www.forexfactory.com/calendar/510-nz-retail-sales-qq",
    "https://www.forexfactory.com/calendar/511-nz-core-retail-sales-qq",
    "https://www.forexfactory.com/calendar/319-nz-anz-business-confidence",
    "https://www.forexfactory.com/calendar/852-nz-businessnz-services-index",
    "https://www.forexfactory.com/calendar/149-nz-businessnz-manufacturing-index",
]
...
NOM_SOURCE = "data-nzd"  # identifiant unique de ce script dans pipeline_status
DOSSIER_CACHE = "cache"
