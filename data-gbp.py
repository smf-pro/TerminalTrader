# -*- coding: utf-8 -*-
"""
data-gbp.py - Script d'extraction de l'HISTORIQUE des indicateurs
economiques GBP - ForexFactory Calendar (version cloud, patron TerminalTrader)
----------------------------------------------------------------------
Reprend la logique de scraping du script local `ffus.py` (tableau
"History" de chaque page calendrier ForexFactory, ex :
https://www.forexfactory.com/calendar/15-uk-official-bank-rate) mais l'adapte au
...
# Liens ForexFactory a suivre pour le GBP. Ajoute / supprime / commente
# une ligne pour modifier la liste des indicateurs suivis.
LIENS = [
    # Taux
    "https://www.forexfactory.com/calendar/15-uk-official-bank-rate",
    # Inflation
    "https://www.forexfactory.com/calendar/82-uk-cpi-yy",
    "https://www.forexfactory.com/calendar/83-uk-core-cpi-yy",
    "https://www.forexfactory.com/calendar/180-uk-average-earnings-index-3my",
    # Emploi
    "https://www.forexfactory.com/calendar/58-uk-unemployment-rate",
    "https://www.forexfactory.com/calendar/68-uk-claimant-count-change",
    # Croissance
    "https://www.forexfactory.com/calendar/33-uk-prelim-gdp-qq",
    "https://www.forexfactory.com/calendar/35-uk-final-gdp-qq",
    "https://www.forexfactory.com/calendar/804-uk-gdp-mm",
    "https://www.forexfactory.com/calendar/114-uk-brc-retail-sales-monitor-yy",
    "https://www.forexfactory.com/calendar/105-uk-retail-sales-mm",
]
...
NOM_SOURCE = "data-gbp"  # identifiant unique de ce script dans pipeline_status
DOSSIER_CACHE = "cache"
